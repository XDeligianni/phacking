...
a<-ggplot(d.exp_sub,aes(x=qmr,fill =subj)) + 
  geom_histogram(binwidth=5,alpha=0.5,position='identity')+scale_fill_viridis_d()
####### Boxplots
...
ggarrange(a, b, labels = c("A","B"),
                    ncol = 2, nrow = 1)
#### t-test
t.test(d.exp_sub[d.exp_sub$subj=="pat",]$qmr, d.exp_sub[d.exp_sub$subj=="ctrl",]$qmr, paired = FALSE,
alternative = "two.sided", conf.level = 0.95,var.equal=TRUE)
```
...
ggarrange(a, b,c, labels = c("A","B","C"),
                    ncol = 2, nrow = 2)
#### t-test
t.test(d.exp[d.exp$subj=="pat",]$qmr, d.exp[d.exp$subj=="ctrl",]$qmr, paired = FALSE,
alternative = "two.sided", conf.level = 0.95,var.equal=TRUE)
...
wilcox.test(d.exp[d.exp$subj=="pat",]$qmr, d.exp[d.exp$subj=="ctrl",]$qmr, paired = FALSE,alternative = "two.sided")
```
