...
Imagine, we have two data distributions, one the **controls** and one a distribution that we want to compare to the control.
...
And let' s assume, that BEFORE starting our analysis, we have a **hypothesis** that in disease presence qmr values are increased.
